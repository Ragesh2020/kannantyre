$(document).ready(function () {
    ...
    $('#submit').click(function () {
        ...
        if (isAllValid) {
            ...
            $.ajax({
                type: 'POST',
                url: 'http://kannantyres.com/ProductsForSale/Bill',
                ...
                success: function (data) {
                    if (data.status) {
                        ...
                        $.ajax({
                            type: 'GET',
                            url: 'http://kannantyres.com/ProductsForSale/Search',
    ...
    $('.lnkclick').click(function () {
        ...
        window.open('http://kannantyres.com/api/Billing/GetBillingListReport?Bllno=' + $('.bllno').text(), 'name', 'width=600,height=400');
    });
