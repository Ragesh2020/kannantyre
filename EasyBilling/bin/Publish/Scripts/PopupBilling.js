$(document).ready(function () {
    ...
    $('#submit').click(function () {
        ...
        if (isAllValid) {
            ...
            $.ajax({
                type: 'POST',
                url: 'http://etreesales.com/ProductsForSale/Bill',
                ...
                success: function (data) {
                    if (data.status) {
                        ...
                        $.ajax({
                            type: 'GET',
                            url: 'http://etreesales.com/ProductsForSale/Search',
    ...
    $('.lnkclick').click(function () {
        ...
        window.open('http://etreesales.com/api/Billing/GetBillingListReport?Bllno=' + $('.bllno').text(), 'name', 'width=600,height=400');
    });
